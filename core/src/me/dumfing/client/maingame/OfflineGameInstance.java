 ...
 */
public class OfflineGameInstance implements InputProcessor{
    ...
    public OfflineGameInstance(HashMap<Integer, PlayerSoldier> players, OrthographicCamera camera, AssetManager manager, Array<BitmapFontCache> fonts){
        this.fonts = fonts;
    ...
    public void update(){
        ...
        playWorld.updatePlayerKeys(0,keysDown);
    ...
    public boolean touchDown(int screenX, int screenY, int pointer, int button) {
        PlayerSoldier clientPlayer = getPlayer(0);
